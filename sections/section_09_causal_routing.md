...
test ran — the analysis is post-hoc, and the results cannot be treated as prospectively
confirmed.
...
it requires a prospectively locked follow-up — head sets declared before any
