...
property of the residual stream rather than a validation-specific artifact. What
those 31 directions have in common — why they are persistent when the other 993 are
not — is the question the remaining sections address.
