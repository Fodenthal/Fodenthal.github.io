...
processing, syntactic parsing, word retrieval, motor preparation — all of it is active,
...
any internal temporal structure — whether some of its directions carry stable signals
across many positions while others decay within one or two tokens. If so, those
