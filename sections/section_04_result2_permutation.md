...
The persistence we measured could in principle reflect something simple: a document
...
provides a joint constraint: the persistence we measure is within-document, sequential,
